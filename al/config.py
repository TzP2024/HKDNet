...
class Config():
    def __init__(self) -> None:
        ...
        if self.refine:
            self.batch_size = 8  # self.batch_size = 16  8
        else:
            if self.bb != 'vgg16':
                self.batch_size = 26  # self.batch_size = 26
            else:
                self.batch_size = 5  # self.batch_size = 48
        ...
        # self.val_measures = {
        #     'Emax': {'RGBD_CoSal1k': 0.913, 'RGBD_CoSal150': 0.944, 'RGBD_CoSeg183': 0.837},
        #     'Smeasure': {'RGBD_CoSal1k': 0.875, 'RGBD_CoSal150': 0.910, 'RGBD_CoSeg183': 0.764, 'val_38':0.845},
        #     'Fmax': {'RGBD_CoSal1k': 0.865, 'RGBD_CoSal150': 0.911, 'RGBD_CoSeg183': 0.654},
        #     'MAE': {'RGBD_CoSal1k': 0.063, 'RGBD_CoSal150': 0.053, 'RGBD_CoSeg183': 0.068},
        # }
        ...
        self.decay_step_size = 5830  # 10000/291~34轮更新一次学习率 3000
        self.rand_seed = 7
